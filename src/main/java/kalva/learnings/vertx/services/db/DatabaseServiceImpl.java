...
public class DatabaseServiceImpl implements DatabaseService {
  ...
  public DatabaseServiceImpl(JDBCClient dbClient, HashMap<SqlQuery, String> sqlQueries,
  ...
  @Override
  public DatabaseService createPage(String title, String markdown, Handler<AsyncResult<Void>> resultHandler) {
  ...
  @Override
  public DatabaseService savePage(int id, String markdown, Handler<AsyncResult<Void>> resultHandler) {
  ...
  @Override
  public DatabaseService deletePage(int id, Handler<AsyncResult<Void>> resultHandler) {
