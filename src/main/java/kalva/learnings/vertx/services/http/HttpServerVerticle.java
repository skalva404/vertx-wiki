package kalva.learnings.vertx.services.http;
...
public class HttpServerVerticle extends AbstractVerticle {
  ...
  public static final String CONFIG_DB_QUEUE = "wikidb.queue";
  ...
  public void start(Future<Void> startFuture) throws Exception {
    ...
    String DbQueue = config().getString(CONFIG_DB_QUEUE, "wikidb.queue");
